...
const Navbar = () => {
    ...
    const [tournamentLink, setTournamentLink] = useState('/join');
    ...
    useEffect(() => {
        ...
        if (userData) {
            ...
            if (role === 'Instructor') {
                ...
                setTournamentLink('/con');
            } else {
                setClassroomLink('/stu');
                setTournamentLink('/join');
            }
        }
            ...
            {isMinimized ? (
                <div className={`sidebar ${menuOpen ? 'active' : ''}`}>
                    ...
                    <ul className="sidebar-menu">
                        ...
                        <li><Link to={tournamentLink} onClick={handleCloseSidebar}>Tournament</Link></li>
                ...
                <ul className="navbar-menu">
                    ...
                    <li><Link to={tournamentLink}>Tournament</Link></li>
